  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <button
        ...
        aria-label={`Notifiche${unreadCount > 0 ? ` - ${unreadCount} non ${unreadCount === 1 ? 'letta' : 'lette'}` : ''}`}
      ...
      >
        ...
        {unreadCount > 0 && (
          <span
            ...
            aria-label={`${unreadCount} notific${unreadCount === 1 ? 'a' : 'he'} non ${unreadCount === 1 ? 'letta' : 'lette'}`}
          >
